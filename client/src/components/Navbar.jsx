...
const Navbar = () => {
  ...
  const {user,setUser,setUserLogin,navigate,searchQuery,setSearchQuery,getCartItemsCount,getCartTotalAmount,axios}= useAppContext();
...
{!user ? ( <button  onClick={()=>setUserLogin(true)} 
