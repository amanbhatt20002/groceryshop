...
const SellerLogin = () => {
  ...
  return !isSeller && (
      ...
      <form  onSubmit={onSubmitHandler} className='min-h-screen flex items-center  justify-center  text-sm text-gray-600'>
        ...
        <div className='flex flex-col items-start  p-8 py-12 min-w-80 sm:min-w-88 rounded-lg shadow-xl border border-gray-200'>
          ...
          <div className='w-full'>
            ...
            className='border border-gray-200 rounded p-2 w-full mt-1 outline-primary'
            required
            />
          </div>
